...
class RustImpl implements Rust {
  ...
  Future<String> appBarName({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_appBarName(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kAppBarNameConstMeta,
      argValues: [],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kAppBarNameConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "appBarName",
        argNames: [],
      );
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void wire_appBarName(
    int port_,
  ) {
    return _wire_appBarName(
      port_,
    );
  }

  late final _wire_appBarNamePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_appBarName');
  late final _wire_appBarName =
      _wire_appBarNamePtr.asFunction<void Function(int)>();
